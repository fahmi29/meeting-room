...
<div class="row ml-12 mt-4">
    <form action="/admin/update-user/<?= $users['id_user'];?>" method="POST">
        <?= csrf_field(); ?>
                    ...
                    <div class="card-body" style="padding: 4%">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="namalengkap" id="namalengkap" placeholder="Name" value="<?= $users['namalengkap'] ?>" />
                            </div>
                            <div class="col-md-6">
                                <label for="email" class="form-label">Email <b style="color: red">*</b></label>
                                <input type="email" class="form-control" name="email" id="email" placeholder="test@test.com" value="<?= $users['email'] ?>" />
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="password" class="form-control" name="password" id="password" placeholder="******" value="<?= $users['password'] ?>" />
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="divisi" id="divisi" class="form-select">
                                    ...
                                    <?php foreach ($divisi as $divisis) :
                                        $select = "";
                                        if($users['divisi'] === $divisis['id_divisi']){ 
                                            $select = "selected";
                                        }else{
                                            $select = "";
                                        } ?>
                                        <option value="<?= $divisis['id_divisi']; ?>" <?= $select?>><?= $divisis['divisi']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select name="jabatan" id="jabatan" class="form-select">
                                    ...
                                    <?php foreach ($jabatan as $jabatans) : 
                                        $select2 = "";
                                        if($users['jabatan'] === $jabatans['id_jabatan']){
                                            $select2 =  "selected";
                                        }else{
                                            $select2 = "";
                                        }
                                        ?>
                                        <option value="<?= $jabatans['id_jabatan']; ?>" <?= $select2 ?>><?= $jabatans['jabatan']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-md-3 mt-4">
                                <button type="button" onclick="save()" class="btn btn-sm btn-outline-success">Update</button>
